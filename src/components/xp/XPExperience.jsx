...
const CV_URL = "/Pushkar_Vashisht_CV_Updated.html";
...
function ControlApp({openApp, actions}){const shortcuts=[["work","Proof folders",Folder],["reels","Reel player",MonitorPlay],["hire","Network",Mail],["cmd","Terminal",Terminal],["note","Readme",FileText],["internet","Internet",Globe2],["paint","Paint",Monitor],["games","Games",MonitorPlay],["bin","Recycle Bin",Folder]];return <div><h1 className="text-4xl font-black text-[#1746b8]">Control Panel</h1><div className="mt-4 grid gap-3 sm:grid-cols-2 md:grid-cols-3">{shortcuts.map(([id,l,Icon])=><button key={id} onClick={()=>openApp(id)} className="rounded border bg-white p-4 text-center hover:bg-blue-50"><Icon className="mx-auto mb-2"/><b>{l}</b></button>)}<button onClick={actions.celebrate} className="rounded border bg-white p-4 text-center hover:bg-blue-50"><b className="text-2xl">✨</b><br/><b>Display</b><br/><small>XP sparkle</small></button><button onClick={()=>actions.showDialog("System message","Your generic portfolio has stopped responding.\n\nWould you like to send a creative operator instead?")} className="rounded border bg-white p-4 text-center hover:bg-blue-50"><b className="text-2xl">!</b><br/><b>Warnings</b><br/><small>Fake alerts</small></button><button onClick={()=>actions.showDialog("File menu","File menu opened. File not found. Confidence intact.")} className="rounded border bg-white p-4 text-center hover:bg-blue-50"><b className="text-2xl">?</b><br/><b>Menu Jokes</b><br/><small>Old HTML bits</small></button><button onClick={()=>openApp("games")} className="rounded border bg-white p-4 text-center hover:bg-blue-50"><b className="text-2xl">☺</b><br/><b>Laugh Lab</b><br/><small>tiny games</small></button><button onClick={()=>actions.setScreensaver(true)} className="rounded border bg-white p-4 text-center hover:bg-blue-50"><b className="text-2xl">&gt;_</b><br/><b>Screensaver</b><br/><small>Activate now</small></button><a href={CV_URL} download="Pushkar_Vashisht_CV_Updated.html" className="rounded border bg-white p-4 text-center hover:bg-blue-50"><FileText className="mx-auto mb-2"/><b>My CV</b><br/><small>Download</small></a></div></div>}
